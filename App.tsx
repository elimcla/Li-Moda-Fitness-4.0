...
const App: React.FC = () => {
  const [currentView, setCurrentView] = useState<'home' | 'shop' | 'login' | 'about' | 'terms' | 'privacy' | 'admin_customers'>('home');
        ...
        <div className="relative z-10 space-y-8 max-w-2xl fade-in">
          <div className="w-24 h-24 bg-[#CCFF00] rounded-full mx-auto flex items-center justify-center mb-10 shadow-[0_0_50px_rgba(204,255,0,0.3)]">
            <svg className="w-12 h-12 text-black animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a2 2 0 00-1.96 1.414l-.593 2.373a2 2 0 01-3.466 0l-.593-2.373a2 2 0 00-1.96-1.414l-2.387.477a2 2 0 00-1.022.547l-1.428 1.428a2 2 0 01-2.828 0l-1.428-1.428a2 2 0 00-1.022-.547l-2.387-.477a2 2 0 00-1.96 1.414l-.593 2.373a2 2 0 01-3.466 0l-.593-2.373a2 2 0 00-1.96-1.414l-2.387.477a2 2 0 00-1.022.547l-1.428 1.428a2 2 0 01-2.828 0l-1.428-1.428z" />
            </svg>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center pt-6">
            <a 
              ...
              target="_blank" 
              className="bg-[#25D366] text-white px-10 py-5 rounded-2xl font-black text-sm uppercase tracking-widest hover:scale-105 transition-all shadow-xl flex items-center justify-center gap-3"
            >
              Falar com Suporte
            </a>
          </div>
          <p className="text-[10px] text-white/20 uppercase tracking-[0.4em] pt-12">Li Moda Fitness • Teresina-PI</p>
        </div>
      </div>
    );
  }
